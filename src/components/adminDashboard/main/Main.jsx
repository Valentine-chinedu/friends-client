				...
				<div className='main__cards'>
					<div className='card_admin'>
						...
						<div className='card_inner_admin'>
							...
							<span className='font-bold text-title'>{auth.total_users}</span>
						</div>
					</div>
					...
					<div className='card_admin'>
						...
						<div className='card_inner_admin'>
							...
							<span className='font-bold text-title'>{auth.total_posts}</span>
						</div>
					</div>
					...
					<div className='card_admin'>
						...
						<div className='card_inner_admin'>
							...
							<span className='font-bold text-title'>{auth.total_likes}</span>
						</div>
					</div>
